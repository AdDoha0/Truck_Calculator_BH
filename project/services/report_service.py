"""
Сервис для отчетов (UI версия).
"""
from typing import List, Dict, Any, Optional
from datetime import date, datetime
from sqlalchemy.orm import Session

from project.models.database import get_db_session, Truck as TruckORM, MonthlyRow as MonthlyRowORM
...
class ReportService:
    ...
    def get_available_periods(self) -> List[str]:
        """Получить доступные периоды из месячных данных."""
    ...
    def get_truck_report(self, truck_id: int, period: Optional[str] = None) -> Dict[str, Any]:
        ...
        with get_db_session() as db:
            ...
            # Рассчитываем затраты через сервис
